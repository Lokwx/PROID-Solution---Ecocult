...
static void Main(string[] args)
{
    ...
    while (true)
    {
        ...
        if (TotalPoints >= 300)
        {
            ...
            {
                Console.WriteLine("You have enough points to exchange " + TotalPoints / 300 + " vouchers");
            }
            else
            {
                Console.WriteLine("You have enough points to exchange " + TotalPoints / 300 + " voucher");
            }
        ...
        if (ExchangePoints == "Yes")
        {
            ...
            //Input verification
            while (NumberOfVouchers > (TotalPoints / 300))
            {
                Console.Clear();
